# ONLINE MARKETING CUSTOMER CONVERSION PREDICTION

## Overview
->Pedicting whether a customer would connvert to a particular online digital campaign team
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/steve601/onlinedigital.git
    cd onlinedigital
    ```
...
**Upload Application Code:**
    ...
    Place the code in a suitable directory, e.g., /home/ec2-user/online-marketing
